...
export class RestriccionDeLavadoService {
     ...
     */
    public apiRestriccionDeLavadoActualizarRestriccionBatchPut(actualizarRestriccionLavadoDto?: Array<ActualizarRestriccionLavadoDto>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<BooleanDataResponse>;
    public apiRestriccionDeLavadoActualizarRestriccionBatchPut(actualizarRestriccionLavadoDto?: Array<ActualizarRestriccionLavadoDto>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<BooleanDataResponse>>;
    public apiRestriccionDeLavadoActualizarRestriccionBatchPut(actualizarRestriccionLavadoDto?: Array<ActualizarRestriccionLavadoDto>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<BooleanDataResponse>>;
    public apiRestriccionDeLavadoActualizarRestriccionBatchPut(actualizarRestriccionLavadoDto?: Array<ActualizarRestriccionLavadoDto>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/RestriccionDeLavado/actualizar-restriccion-batch`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiRestriccionDeLavadoRestriccionPorMaquinaGet(idMaquina?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<RestriccionLavadoDtoIEnumerableDataResponse>;
    public apiRestriccionDeLavadoRestriccionPorMaquinaGet(idMaquina?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<RestriccionLavadoDtoIEnumerableDataResponse>>;
    public apiRestriccionDeLavadoRestriccionPorMaquinaGet(idMaquina?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<RestriccionLavadoDtoIEnumerableDataResponse>>;
    public apiRestriccionDeLavadoRestriccionPorMaquinaGet(idMaquina?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/RestriccionDeLavado/restriccion-por-maquina`;
        return this.httpClient.request<RestriccionLavadoDtoIEnumerableDataResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
