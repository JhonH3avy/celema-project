...
export class RestriccionMaquinasService {
     ...
     */
    public apiRestriccionMaquinasActualizarRestriccionBatchPut(actualizarRestriccionMaquinaDto?: Array<ActualizarRestriccionMaquinaDto>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<BooleanDataResponse>;
    public apiRestriccionMaquinasActualizarRestriccionBatchPut(actualizarRestriccionMaquinaDto?: Array<ActualizarRestriccionMaquinaDto>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<BooleanDataResponse>>;
    public apiRestriccionMaquinasActualizarRestriccionBatchPut(actualizarRestriccionMaquinaDto?: Array<ActualizarRestriccionMaquinaDto>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<BooleanDataResponse>>;
    public apiRestriccionMaquinasActualizarRestriccionBatchPut(actualizarRestriccionMaquinaDto?: Array<ActualizarRestriccionMaquinaDto>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/RestriccionMaquinas/actualizar-restriccion-batch`;
